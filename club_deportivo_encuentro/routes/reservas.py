...
from ..validators.reservas import validar_body_crear_reserva, validar_body_cambiar_estado, validar_estado, validar_rango_fechas,validar_ids_reserva
...
def get_reservas():
    ...
    try:
        ...
        fecha_desde, fecha_hasta = validar_rango_fechas (request.args.get('fecha_desde'), request.args.get('fecha_hasta'))
        id_socio = validar_ids_reserva(request.args.get('id_socio'), 'id_socio')
        id_cancha = validar_ids_reserva(request.args.get("id_cancha"), "id_cancha")
